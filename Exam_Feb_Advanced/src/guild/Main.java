...
//        Guild guild = new Guild("Weekend Raiders", 2);
//        Player player = new Player("Mark", "Rogue");
//        Player player1 = new Player("Nick", "Rogue");
//        Player player2 = new Player("March", "Rogue");
//
//        guild.addPlayer(player);
//        guild.addPlayer(player1);
//        guild.addPlayer(player2);
//        guild.removePlayer("Mark");
//
//        Player[] kickedPlayers = guild.kickPlayersByClass("f");
//        for (Player kickedPlayer : kickedPlayers) {
//            System.out.print(kickedPlayer.getName() + " ");
//        }
//
//        guild.promotePlayer("Nick");
//
//
//        System.out.println(guild.report());
//
//        guild.demotePlayer("Nick");
//        System.out.println("--------------");
//        System.out.println(guild.report());
//
